...
- [05. Корреляционный анализ](#05-корреляционный-анализ)
  ...
  - [Парные статистические связи](#парные-статистические-связи)
    ...
    - [Коэффициент корреляции Пирсона (метрические шкалы)](#коэффициент-корреляции-пирсона-метрические-шкалы)
      ...
      - [Выводы](#выводы)
  - [Практическая работа. Исследование меры линейной связи между двумя признаками](#практическая-работа-исследование-меры-линейной-связи-между-двумя-признаками)
    - [Задание](#задание)
...
### Практическая работа. Исследование меры линейной связи между двумя признаками
Цель:
