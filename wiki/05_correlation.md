...
1. Данные делятся на две подгруппы по бинарному признаку:
   ...
   - Группа с признаком, равным 1 ("м") (например, $n_1$ элементов): 175, 180, 178, 183, 176. $n_м = 5$.

   - Группа с признаком, равным 0 (например, $n_0$ элементов): 170, 172, 168, 165, 174. $n_ж = 5$.
