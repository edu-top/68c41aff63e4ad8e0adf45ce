...
Для каждого восстанавливаемого признака обосновать выбор того или иного метода. Сделать выводы об эффективности реализованных методов восстановления для каждого признака на основе методов сравнения результатов восстановления с фактическими значениями отсутствующих признаков.
