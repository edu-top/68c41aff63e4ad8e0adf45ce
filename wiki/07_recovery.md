...
Метрика <dfn title="accuracy">accuracy</dfn> — это простая и интуитивно понятная мера качества импутации категориальных признаков, которая показывает долю правильно восстановленных значений. Accuracy вычисляется как отношение числа верно импутированных категорий к общему числу искусственно созданных пропусков (маск-аут):
