...
Таким образом, метод  с использованием относительного отклонения (в %) не подходит для данных с нулевыми или близкими к нулю значениями, где деление на исходное значение приводит к неопределённости или завышенным ошибкам. В таких случаях лучше комбинировать с абсолютными метриками, такими как MAE или RMSE. Также усреднение маскирует локальные проблемы восстановления в отдельных точках.
