...
Наша задача заключается в том, чтобы разобраться, что такое машинное обучение и сформулировать объект и предмет МО. Далее мы рассмотрим основные концепции машинного обучения, включая типы задач, алгоритмы и инструменты, используемые для создания моделей машинного обучения.[^machine] Кроме того, мы изучим взаимосвязь машинного обучения с другими смежными дисциплинами — искусственным интеллектом (aritificial intelligence), большими данными (big data), наукой о данных (data science), компьютерными науками (computer science), информатикой (information science) и т.п..
