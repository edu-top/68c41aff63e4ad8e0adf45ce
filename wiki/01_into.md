...
- <dfn title="данные">Данные</dfn> (обучающая выборка) — набор примеров, на которых алгоритм обучается. Другими словами, <dfn title="обучающая выборка">обучающая выборка</dfn> — это информация (набор данных), используемая для обучения алгоритма. Этот набор содержит входные данные и соответствующие им выходные результаты. **Отличие информации от данных**: данные для машины, информация имеет значение для человека.
