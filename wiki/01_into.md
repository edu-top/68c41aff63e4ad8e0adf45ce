...
- [01. Введение в машинное обучение и большие данные](#01-введение-в-машинное-обучение-и-большие-данные)
  ...
  - [Машинное обучение](#машинное-обучение)
    ...
    - [Применение машинного обучения в бизнесе](#применение-машинного-обучения-в-бизнесе)
...
- <dfn title="данные">Данные</dfn> (обучающая выборка) — набор примеров, на которых алгоритм обучается. Другими словами, <dfn title="обучающая выборка">обучающая выборка</dfn> (*dataset*) — это информация (набор данных), используемая для обучения алгоритма. Этот набор содержит входные данные и соответствующие им выходные результаты. **Отличие информации от данных**: данные для машины, информация имеет значение для человека.
...
- <dfn title="обучение с учителем">Обучение с учителем</dfn> (*supervised learning*) — алгоритм учится на основе размеченных данных, стремясь находить зависимости и прогнозировать результаты. При этом есть правильные ответы (метки) на обучающих данных, например, классификация (распределение писем на спам и не спам), регрессия (прогноз цены дома).

- <dfn title="обучение без учителя">Обучение без учителя</dfn> (*unsupervised learning*) — здесь алгоритм работает с не размеченными данными, пытаясь выявить в них структуру или закономерности. При этом нет меток, задача — найти структуру в данных (кластеризация, понижение размерности);

- <dfn title="обучение с подкреплением">Обучение с подкреплением</dfn> (reinforcement learning) — обучение на основе наград и штрафов от взаимодействия с окружением. В этом случае машина учится, основываясь на «награде» или «штрафе» в ответ на свои действия, стремясь максимизировать свою «выгоду».
...
: подход к машинному обучению, при котором алгоритм работает с не размеченными данными, пытаясь выявить в них структуру или закономерности. При этом нет меток, задача — найти структуру в данных (кластеризация, понижение размерности);

Обучение с учителем (*supervised learning*)
: подход к машинному обучению, при котором алгоритм учится на основе размеченных данных, стремясь находить зависимости и прогнозировать результаты. При этом есть правильные ответы (метки) на обучающих данных, например, классификация (распределение писем на спам и не спам), регрессия (прогноз цены дома).

Обучение с подкреплением (reinforcement learning)
: обучение на основе наград и штрафов от взаимодействия с окружением. В этом случае машина учится, основываясь на «награде» или «штрафе» в ответ на свои действия, стремясь максимизировать свою «выгоду».
