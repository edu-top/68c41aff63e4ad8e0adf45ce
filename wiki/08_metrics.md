...
d_1(A_2, A_3) = |5−4| + |5−3| + |5−3| + |4−2| = 1 + 2 + 2 + 2 = 7 = d_{max}\\[1ex]

d_1(A_2, A_4) = |5−5| + |5−4| + |5−3| + |4−3| = 0 + 1 + 2 + 1 = 4\\[1ex]

d_1(A_3, A_4) = |4−5| + |3−4| + |3−3| + |2−3| = 1 + 1 + 0 + 1 = 3 = d_{min}
$$
...
d_2(A_2, A_3) = \sqrt{ (5−4)^2 + (5−3)^2 + (5−3)^2 + (4−2)^2 } = \sqrt{1 + 4 + 4 + 4} = \sqrt{13} ≈ 3.606 = d_{max}\\[1ex]

d_2(A_2, A_4) = \sqrt{ (5−5)^2 + (5−4)^2 + (5−3)^2 + (4−3)^2 } = \sqrt{0 + 1 + 4 + 1} = \sqrt{6} ≈ 2.449\\[1ex]

d_2(A_3, A_4) = \sqrt{ (4−5)^2 + (3−4)^2 + (3−3)^2 + (2−3)^2 } = \sqrt{1 + 1 + 0 + 1} = \sqrt{3} ≈ 1.732 = d_{min}

$$

$L_\infty$-расстояние (Чебышёва): $d_∞(A_i, A_j) = \max_k{| P_k(A_i) − P_k(A_j)|}$
...
d_∞(A_3, A_4) = \max(|4−5|, |3−4|, |3−3|, |2−3|) = \max(1, 1, 0, 1) = 1 = d_{min}
