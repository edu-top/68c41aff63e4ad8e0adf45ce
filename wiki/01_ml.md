...
: это информация (набор данных), используемая для обучения алгоритма. Представляет собой совокупность примеров (входных объектов) и соответствующих им правильных ответов. Этот набор содержит входные данные, на которых модель обучается (т.е. на основе которых она настраивает свои веса и определяет зависимости между входными данными и целевой переменной) и соответствующие им выходные результаты.
