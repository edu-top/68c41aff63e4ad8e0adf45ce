...
- [Проектирование промптов](#проектирование-промптов)
  ...
  - [Практическая работа. Создание текста с помощью промптов](#практическая-работа-создание-текста-с-помощью-промптов)
    - [Задание](#задание-2)
...
### Практическая работа. Создание текста с помощью промптов

#### Задание
Сгенерировать текст с помощью любой LLM.

1. Пусть нейросеть поможет вам решить текущую учебную или рабочую задачу, напишет фрагмент научного текста или составит реалистичный план исследования (например, на тему "Влияние ИИ на образование").

2. Использовать разные типы промптов, по необходимости сочетая их между собой.

3. Добавить в запрос дополнительные элементы: контекст, инструкцию, роль, стиль/тон текста.

4. Задать дополнительные вопросы, чтобы улучшить качество результата.

5. Проанализировать: какой тип промпта дал лучший результат? Почему?

Сохранить переписку как артефакт, оформить отчет по результатам работы в соответствии со стандартами учебного заведения к оформлению квалификационных работ.
